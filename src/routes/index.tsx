...
const PAST_SERVERS = [
  {
    ...
    role: 'Owner',
    period: '2026',
    serverIp: 'eclipsesmp.nl',
    playerPeak: '80 concurrent',
    description:
      'Developed the entire server, Sadly shutdown due to innsuficient funds.',
    tags: ['Economy', 'Lifesteal', 'Pvp', 'Anarchy'],
    status: 'shutdown',
  },
  {
    name: 'TurtleSMP',
    ...
    tags: ['Economy', 'PvP', 'SkyBlock', 'Shop Survival'],
    status: 'active',
  },
  {
    name: 'MonkeyVanilla',
  ...
  },
  {
    ...
    role: 'Developer',
    period: '2026',
    serverIp: 'cromevanilla.net',
    playerPeak: '33 concurrent',
    description:
      'Configuring most of their plugins and more, Season 2 in Progress.',
    tags: ['Economy', 'Survival', 'Shop Survival'],
    status: 'active',
  },
  {
    name: 'LuxSMP',
    ...
    period: '2026',
    serverIp: 'luxsmp.org',
    playerPeak: '78 concurrent',
    description:
      'Fixing bugs and doing optimization for a lag-free experience.',
  ...
  },
  {
    ...
    role: 'Developer',
    period: '2026',
    serverIp: 'blazesmp.us',
    playerPeak: '30 concurrent',
    description:
      'Developed multiple custom plugins and configured all of the plugins.',
    tags: ['Economy', 'SMP', 'Survival'],
    status: 'shutdown',
  },
  {
